...
.controller('CanvasCtrl', function($scope, $interval) {
  $scope.timeCount = 10;
  ...
  console.log('screen.availWidth: ' + window.screen.availWidth + ', screen.availHeight: ' + window.screen.availHeight);
  ...
  canvas.addEventListener("touchstart", function(event) {
    ...
    var rect = canvas.getBoundingClientRect();
    var startX = touch.clientX - rect.left;
    var startY = touch.clientY - rect.top;
